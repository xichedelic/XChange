...
import org.knowm.xchange.uabpervesk.dto.BaseBankeraRequest;
import org.knowm.xchange.uabpervesk.dto.CreateOrderRequest;
...
public interface BankeraAuthenticated extends Bankera {
  ...
  PaymentEntriesResponse getPaymentEntries(
      @HeaderParam("Authorization") String authorization
  ) throws BankeraException, IOException;
}